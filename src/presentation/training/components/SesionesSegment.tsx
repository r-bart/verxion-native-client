...
export function SesionesSegment() {
  ...
  return (
    <>
        ...
        renderItem={({ item }) =>
          item.kind === "header" ? (
            <SessionBlockHeader
              ...
              dateRange={item.block.dateRange}
              totalVolume={item.block.totalVolume}
            />
          ) : (
      ...
      >
        <SheetOption
          label={t("training.sessionFeed.allRoutines")}
