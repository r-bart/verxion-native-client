/**
 * DiaDetalleScreen — read-only plan for any training day (not the "start"
 * screen; that's Prescripción). Phase 0: scaffold + demo push to an exercise.
 */
...
export function DiaDetalleScreen() {
  ...
  return (
    <DetailScaffold title={t("training.screens.dayDetail")}>
      <WipBody screen={t("training.screens.dayDetail")} params={{ id }} />
