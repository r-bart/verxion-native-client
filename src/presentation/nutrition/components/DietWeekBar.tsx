/**
 * DietWeekBar — the active diet's week progress: "Semana 3 de 6" + a ScoreChip
 * over a row of week cells. Completed weeks fill lava; the current week fills
...
export function DietWeekBar({ diet }: { diet: ActiveDietSummary }) {
  ...
  const { week, weekFraction, scoreState } = diet;
