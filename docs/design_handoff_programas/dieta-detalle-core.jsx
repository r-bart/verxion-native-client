...
function DietaDetalleScreen({ t }) {
  ...
  // si se llega desde un programa, "volver" regresa al programa, no a Dietas
    ...
    <div className="dt-screen">
      <div className="dt-scroll">
        <div className="dt-chrome">
          <button className="dt-chrome__btn" aria-label="Volver" onClick={back}><Icon.chevronLeft size={20} /></button>
